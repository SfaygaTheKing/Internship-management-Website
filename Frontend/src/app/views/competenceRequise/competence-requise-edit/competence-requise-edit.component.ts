...
@Component({
  selector: 'app-competence-requise-edit',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './competence-requise-edit.component.html',
  styleUrl: './competence-requise-edit.component.css',
})
export class CompetenceRequiseEditComponent implements OnInit {
  ...
  update(): void {
    if (this.validateForm()) {
      this.competenceRequiseService.update().subscribe({
        next: (data) => {
          if (data !== null) {
